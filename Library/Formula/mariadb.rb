...
class Mariadb <Formula
  homepage 'http://kb.askmonty.org/v/mariadb-524-release-notes'
  url 'http://www.percona.com/downloads/MariaDB/mariadb-5.2.4/kvm-tarbake-jaunty-x86/mariadb-5.2.4.tar.gz'
  md5 'f58ab0b97e99b2359c33d43b9e636ed7'
