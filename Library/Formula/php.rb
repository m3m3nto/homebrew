...
class Php <Formula
  ...
  def install
    ...
    #mkdir "#{prefix}/etc/php5"
    #mkdir "#{HOMEBREW_PREFIX}/etc/php5/conf.d" unless File.exists?("#{HOMEBREW_PREFIX}/etc/php5/conf.d")
    #prefix.install ['php5']
    #system "cp ./php.ini-production #{prefix}/etc/php5/php.ini"
